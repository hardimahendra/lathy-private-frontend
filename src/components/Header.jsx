    ...
    <>
      <div className="flex justify-around items-center w-full h-[80vh]  bg-cover bg-center">
        <div className="relative flex flex-column justify-center items-left w-[50%] h-full">
          ...
          <button className="absolute right-0 bottom-[20%] flex justify-center items-center md:w-[200px] md:h-[50px]  shadow-lg transition-all duration-100 rounded hover:border-2 bg-orange-500 ">
