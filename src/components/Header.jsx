      ...
      <div className="flex lg:justify-around justify-center items-center w-full h-svh  bg-cover bg-center">
        <div className="relative flex flex-column justify-center lg:w-[50%] w-[90%] h-full ">
          ...
          <div className="text-white">
            <button className="absolute right-0 bottom-[20%] flex justify-center items-center md:w-[200px] md:h-[50px] p-2 shadow-lg transition-all duration-100 rounded bg-orange-600 hover:bg-transparent hover:border-2 hover:border-orange-500 hover:text-orange-500">
              <Link to="/program">Mau liat dong</Link>
            </button>
          </div>
        </div>
