  ...
  return (
    <Modal
        ...
        >
                ...
                <Modal.Body>
                    <p >
                    Saat ini pelayanan yang kami sudah mencakup seluruh wilayah Banten. Dengan 70 lebih tenaga pendidik, kami mampu melayani semua peserta didik dengan optimal. Dalam perjalanan dan pengembangannya, Lathy Private terus menggali, mempelajari dan mengembangakan metode pembelajaran yang optimal untuk diterapkan pada peserta didik. 
