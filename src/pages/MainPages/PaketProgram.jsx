...
const PaketProgram = () => {
  return (
    <>
      <div className="flex w-[50%] h-auto justify-center items-center text-white  ">
        <div className="flex flex-column w-full justify-center item-center">
          <h1 className="pb-6 text-lg font-semibold">Pilih Paket Les </h1>
          <div className="flex flex-row flex-wrap justify-between item-center">
            <div className="flex flex-column h-[350px] w-[250px] rounded shadow-lg gap-5 items-center justify-center">
              ...
              <h3>6 Sesi </h3>
              <h5>Rp. 500.000</h5>
              <button className=" py-2 px-4 border-b-2 transition-all  rounded duration-200 hover:bg-orange-500">Pilih Program</button>
            </div>
            <div className="flex flex-column h-[350px] w-[250px] rounded shadow-lg gap-5 items-center justify-center ">
