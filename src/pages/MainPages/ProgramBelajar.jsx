        ...
        <div className="flex flex-column items-center justify-center">
          ...
          <div className="flex flex-column text-left pt-2 gap-2" hidden={index != 0}>
            ...
            <p>
              ...
              privat untuk pelajaran SD yang sesuai sama kebutuhan. Enaknya lagi, bisa belajar online atau offline, dan adek-adek juga bisa pilih sendiri waktu yang nyaman. Jadi, gak perlu lagi deh mikirin kesulitan belajar di kelas, karena
              LapakGuruPrivat.com siap bantu adek-adek buat ngejar pelajaran SD dengan lebih enjoy!
            </p>
